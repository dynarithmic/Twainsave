...
#define RETURN_RETURNCODE_MSG           23
#define RETURN_BROKER_ERROR             24
#define RETURN_DTWAINDLL_NOT_FOUND      25
#define RETURN_TWAININFO_FILE_ERROR     26
#define RETURN_DTWAININI_FILE_ERROR     27
#define RETURN_DTWAINDLL_WRONG_VERSION  28
#define RETURN_DTWAINDLL_WRONG_VERSION_MSG 29
#define RETURN_GENERATEDETAILS_MSG      30
#define RETURN_CODE_LAST (RETURN_GENERATEDETAILS_MSG + 1)

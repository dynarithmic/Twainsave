        ...
        class options_base
        {
            public:
                ...
                static void apply(twain_source_base& ts, deviceparams_options& dp)
                {
                    ...
                    ci.set_cap_values< CAP_DEVICETIMEDATE_>({ dp.m_TimeDate });
                    if (dp.m_ExposureTime != DBL_MIN)
                ...
                static void apply(twain_source_base& ts, autoadjust_options& ao)
                {
                    ...
                    if ( ao.m_ImageMergeHeightThreshold != DBL_MIN)
                ...
                {
                    auto& ci = ts.get_capability_interface();
                    if (ro.m_xResolution != DBL_MIN)
                        ci.set_cap_values< ICAP_XRESOLUTION_>({ ro.m_xResolution });
                    if (ro.m_yResolution != DBL_MIN)

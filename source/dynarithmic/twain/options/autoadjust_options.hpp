...
namespace dynarithmic
{
    namespace twain
    {
        ...
        class autoadjust_options
        {
            ...
            double  m_ImageMergeHeightThreshold;
            ...
            public:
                ...
                autoadjust_options() : m_bSenseMedium(false),
                                                            ...
                                                            m_ImageMergeHeightThreshold(DBL_MIN)
                {}
                ...
                autoadjust_options& set_mergeheightthreshold(double threshold) noexcept
                ...
                double get_mergeheightthreshold() const noexcept { return m_ImageMergeHeightThreshold; }

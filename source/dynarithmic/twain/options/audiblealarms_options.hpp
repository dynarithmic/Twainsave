...
namespace dynarithmic
{
    namespace twain
    {
        ...
        class audiblealarms_options
        {
            ...
            std::vector<uint16_t> m_vAlarms;
            int32_t m_AlarmVolume;
            ...
            public:
                ...
                audiblealarms_options() : m_AlarmVolume(INT_MIN) {}
                ...
                /// @note To turn off the volume setting, pass INT_MIN to this function
                audiblealarms_options& set_alarmvolume(int32_t value) noexcept
                ...
                ///                     get_alarmvolume();
                /// \endcode
                /// @returns a int32_t representing the alarm volume.  If no alarm volume is set, INT_MIN is returned.
                /// @note The return value of INT_MIN is the minimum 32-bit integer value supported by the C++ compiler.
                int32_t get_alarmvolume() const noexcept { return m_AlarmVolume; }
                ...
                ///                   get_alarms();
                /// \endcode
                /// @returns a std::vector<uint16_t>, where each element is an alarms option
                ...
                /// @note The container to use must have a value_type of **uint16_t**

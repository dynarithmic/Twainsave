...
namespace dynarithmic
{
    namespace twain
    {
        ...
        {
            static LONG get_multipage_type(filetype_value::value_type ft)
            {
                static std::unordered_map<filetype_value::value_type, LONG> multipage_map =
                {

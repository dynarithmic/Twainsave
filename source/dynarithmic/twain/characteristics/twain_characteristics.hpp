...
#ifndef DTWAIN_TWAIN_CHARACTERISTICS_HPP
#define DTWAIN_TWAIN_CHARACTERISTICS_HPP
...
#include <dynarithmic/twain/logging/logger_characteristics.hpp>
    ...
    namespace twain {
        ...
        */
        class twain_characteristics
        {
            ...
            logger_characteristics m_loggingCharacteristics;
            ...
            bool check_handles;
            twain_select_dialog m_twain_dialog;
        ...
        public:
            ...
            /// Sets the logging characteristics.
            /// 
            /// This function allows an application to completely replace the current set of logger_characteristics with another.
            /// @param[in] logging_chars Reference to the logger_characteristics to use as the current
            /// @returns Reference to current twain_characteristics object (**this**)
            twain_characteristics& set_logger_characteristics(const logger_characteristics& logging_chars) noexcept { m_loggingCharacteristics = logging_chars; return *this; }
            ...
            */
            ...
            /// Gets the reference to the logging characteristics.
            /// 
            /// @returns Reference to current logger_characteristics
            /// @see set_logger_characteristics()
            logger_characteristics& get_logger_characteristics() noexcept { return m_loggingCharacteristics; }
            ...
            */
            ...
            /// Gets the reference to the twain_select_dialog that represents the TWAIN Select Source dialog object.
            /// 
            /// The TWAIN Select Source dialog is shown to the user to allow a TWAIN device to be selected.
            /// The object can be used to customize the placement, font used, etc.  of the dialog box.
            /// @returns Reference to TWAIN dialog object.
            twain_select_dialog& get_twain_dialog() noexcept { return m_twain_dialog; }
